...
# Rimuovi colonne inutili (es. ID)
data_cleaned = data.drop(columns=['ID'])

# Gestione valori mancanti: sostituisci i NaN con la media per colonne numeriche
...
# Nuovo dato di input (esempio con alcune colonne)
new_data = pd.DataFrame([#[0, 0, 1, 65.73150685, 217.844118090573, 320.267425132414, 243.916302872017, -6047.69070699494, 25436.7528335256, -0.00305285732059407],
...
for col in all_columns:
    if col not in new_data.columns:
        new_data[col] = 0.0  # Sostituisci con un valore predefinito, se necessario

# Riordina le colonne per corrispondere al dataset originale
